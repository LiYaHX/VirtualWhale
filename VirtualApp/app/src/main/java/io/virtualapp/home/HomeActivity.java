...
import static com.lody.whale.xposed.XposedHelpers.setBooleanField;
...
public class HomeActivity extends VActivity implements HomeContract.HomeView {
    ...
    private void initMenu() {
        ...
        menu.add("Virtual Storage").setIcon(R.drawable.ic_vs).setOnMenuItemClickListener(item -> {
            ...
            // TODO
            // dynamic load thirty-part code, and effect with the app that loaded the VirtualApp
            // @2019.09.30 Hai-Yang Li
            someClass.doSomething("aabb", 9, new MyClass());
        ...
        /**-------------------- This is test whale hook framework ---------------------*/
        testHook();
        hookMethod();
        hookConstruct();
    ...
    private void testHook() {
        ...
        XposedHelpers.findAndHookMethod("io.virtualapp.home.SomeClass",
//                SomeClass.class.getClassLoader(),           // llp.classLoader
                getApplication().getClassLoader(),
                "doSomething",
                String.class,
                int.class,
                "io.virtualapp.home.MyClass",
                new XC_MethodHook() {
    ...
    private void hookMethod() {
        ...
        XposedHelpers.findAndHookMethod(SomeClass.class, "haiyang", new XC_MethodHook() {

            @Override
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                super.beforeHookedMethod(param);
                Log.i(TAG, "2. hook private haiyang method.");
            }
    ...
    private void hookConstruct() {

        XposedHelpers.findAndHookConstructor(SomeClass.class, new XC_MethodHook() {

            @Override
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                super.beforeHookedMethod(param);
                Log.i(TAG, "1. hook construct method.");
            }
