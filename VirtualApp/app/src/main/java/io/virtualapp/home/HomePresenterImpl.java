...
class HomePresenterImpl implements HomeContract.HomePresenter {
    ...
    public void dataChanged() {
        mView.showLoading();
        mRepo.getVirtualApps().done(mView::loadFinish).fail(mView::loadError);  // @2019.09.27 Hai-Yang Li   Java Lambda Expressions:
                                                                                //                                https://www.jianshu.com/p/85affe38ce5c
    ...
    public void addApp(AppInfoLite info) {
        ...
        VUiKit.defer().when(() -> {
            ...
            if (addResult.justEnableHidden && !info.isHook) {   // @Hai-Yang Li 2019.10.11
